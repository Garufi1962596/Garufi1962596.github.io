    ...
    namespace hw4c_
    {
        public partial class Form1 : Form
        {
            ...
            private void distribution(object sender, EventArgs e)
            {
                ...
                PopulateDataGridView(GridControls[1], sortedDict, Sport.Count);
    
                Dictionary<string, int> countJoin = FreqDistrJoin(variable, interval);
                PopulateDataGridView(GridControls[0], countJoin, 10);
